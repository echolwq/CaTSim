...
def parameter_parser():
    ...
    parser.add_argument("--model",
                        type=int,
                        default=0,
                        help="Model specification. Default 0 is baseline model. 1 is local-global contrast model. 2 is top-two nodes model. 3 is final model CaTSim")
    
    parser.add_argument("--dataset",
                        type=str,
                        default="AIDS700nef",
                        help="Dataset used. Default is AIDS700nef model")
